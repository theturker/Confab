...
public class CustomAdapter extends ArrayAdapter<Message> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (firebaseUser.getEmail().equalsIgnoreCase(message.getGonderici())){
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_right_item_layout, parent, false);
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_left_item_layout, parent, false);
